                ...
                <div class="dashboard-profile-wrapper">
                        ...
                        <ul class="nav flex-column nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="preference-tab" data-bs-toggle="pill"
                                    data-bs-target="#preference" type="button" role="tab" aria-controls="preference"
                    ...
                    <div class="tab-content w-100" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="preference" role="tabpanel" aria-labelledby="preference-tab">
                            <div class="dashboard-profile-tab-content">
                                <div class="profile-tab-content-title">
                                    <h6>Previous Bookings Details</h6>
                                </div>
                                <table class="table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @if ($data->bookings->count())
                                            ...
                                            <tr>
                                                <td>{{$index+1}}</td>
                                                <td>{{$booking->package->destination->title}}</td>
                                                <td>{{$booking->package->package_title}}</td>
                                                <td>{{$booking->voucher->user->name}}</td>
                                                <td>{{$data->created_at}}</td>
                                            </tr>
                                            @endforeach
                                        @endif

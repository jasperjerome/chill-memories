        ...
        <div class="col-xl-12">
            ...
            <div class="dashboard-profile-wrapper two">
                <div class="dashboard-profile-tab-content">
                    <form action="{{route('app.destinations.update', ['id'=>$data->id])}}" method="post" enctype="multipart/form-data"> 
                        @method('put')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-inner mb-30">
                                    ...
                                    <input type="text" name="meta_desc" value="{{$data->meta_desc}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-inner mb-30">
                            ...
                            <div class="col-md-12 mb-30">
                                <div class="form-inner">
                                    ...
                                    <textarea placeholder="Description here" name="long_desc" rows="4" id="long_desc">{{$data->long_desc}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-inner mb-30">
